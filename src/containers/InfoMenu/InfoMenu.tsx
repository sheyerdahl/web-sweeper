...
function InfoMenu(): JSX.Element {
    return (
            <div className="Main-content ml7">
                ...
                <p>Your goal is to reveal all tiles without a mine. Tiles display how many mines are around it, including diagonally. Place flags on mines to remember them, you can't activate tiles with flags. Lastly, have fun!</p>
